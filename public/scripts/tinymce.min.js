...
!(function () {
				...
				f = (o, a, i) => {
					...
					Tm(o, a, a => {
						...
						const p = a => {
							...
							if (
								(o => (e => mm(e) && !0 === e.wrapper)(s) && cb(e, o, t, n))(a)
							)
								u = null;
							else {
								if (
								  ...
								  (s.exact ||
										...
										(a = (e => {
											const t = J(e.childNodes, Xu).filter(
												e => 'false' !== o.getContentEditable(e) && lb(o, e, s)
											);
											return t
												.map(t => {
													const n = o.clone(t, !1);
	...
	const Cv = (e, t, n) =>
		...
		xv = (e, t, n = !1) =>
			Cv(t, n, (t, n) =>
				I.from(e.getByData(t, n)).orThunk(() => bv(n, t).map(n => wv(e, n, t)))
			);
	function kv(e) {
		return (
			(kv =
			...
			if (!t && FE(o, s)) {
				const o = ((e, t, n) =>
					((e, t) =>
						...
						.orThunk(() =>
							le(n.getClientRects()).bind(n => Wx(Xx(e, Bi.before(t)), n.left))
						)
...
tinymce.baseURL =
	'https://cdn.tiny.cloud/1/qagffr3pkuv17a8on1afax661irst1hbr4e6tbv888sz91jc/tinymce/6.4.1-16';
